...
public class TestCircle {
	public static void main(String[] args) {
		...
		c1.radius = 12.5;
		System.out.println("Radius of object c1 = "+c1.getredius());
		System.out.println("Area of object c1 = "+c1.getArea());
		System.out.println();
		c2.radius = 5.5;
		System.out.println("Radius of object c2 = "+c2.getredius());
		System.out.println("Area of object c2 = "+c2.getArea());
		
		System.out.println(showColor("red"));//call atatic method name showColor
